...
import com.booking.tai.service.CommentService;
...
/**
 * REST controller for managing {@link com.booking.tai.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
public class CommentResource {
     ...
     */
    @GetMapping("/comments")
    public List<Comment> getAllComments(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
