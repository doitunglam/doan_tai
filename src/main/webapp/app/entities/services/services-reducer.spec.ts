...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './services.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICES_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICES actions', async () => {
      const expectedActions = [
        {
