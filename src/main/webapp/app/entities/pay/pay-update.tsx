  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="doantaiApp.pay.home.createOrEditLabel" data-cy="PayCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Code" id="pay-code" name="code" data-cy="code" type="text" />
              <ValidatedField label="Cost" id="pay-cost" name="cost" data-cy="cost" type="text" />
              <ValidatedField id="pay-user" name="user" data-cy="user" label="User" type="select">
                <option value="" key="0" />
                {users
