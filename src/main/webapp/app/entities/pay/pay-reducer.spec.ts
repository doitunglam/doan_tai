...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pay.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAY actions', async () => {
      const expectedActions = [
        {
