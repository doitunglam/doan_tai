...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGEROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGEROOM actions', async () => {
      const expectedActions = [
        {
