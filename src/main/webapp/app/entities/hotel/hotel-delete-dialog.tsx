...
export const HotelDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="doantaiApp.hotel.delete.question">Are you sure you want to delete this Hotel?</ModalBody>
      <ModalFooter>
