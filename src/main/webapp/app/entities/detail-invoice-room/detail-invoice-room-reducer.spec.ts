...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './detail-invoice-room.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETAILINVOICEROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETAILINVOICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETAILINVOICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETAILINVOICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETAILINVOICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETAILINVOICEROOM actions', async () => {
      const expectedActions = [
        {
