...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGESERVICES_LIST actions', async () => {
    ...
    it('dispatches FETCH_IMAGESERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IMAGESERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IMAGESERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IMAGESERVICES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IMAGESERVICES actions', async () => {
      const expectedActions = [
        {
