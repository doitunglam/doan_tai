...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './type-room.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPEROOM actions', async () => {
      const expectedActions = [
        {
