...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETAILINVOICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETAILINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETAILINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETAILINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETAILINVOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETAILINVOICE actions', async () => {
      const expectedActions = [
        {
