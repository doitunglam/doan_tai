...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRICEROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRICEROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRICEROOM actions', async () => {
      const expectedActions = [
        {
