...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMHOTEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROOMHOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROOMHOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROOMHOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROOMHOTEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROOMHOTEL actions', async () => {
      const expectedActions = [
        {
