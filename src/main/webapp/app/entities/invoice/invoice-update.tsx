  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="doantaiApp.invoice.home.createOrEditLabel" data-cy="InvoiceCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Created Date" id="invoice-createdDate" name="createdDate" data-cy="createdDate" type="date" />
              <ValidatedField label="Cost" id="invoice-cost" name="cost" data-cy="cost" type="text" />
              <ValidatedField label="Paycode" id="invoice-paycode" name="paycode" data-cy="paycode" type="text" />
              <ValidatedField id="invoice-user" name="user" data-cy="user" label="User" type="select">
                <option value="" key="0" />
                {users
