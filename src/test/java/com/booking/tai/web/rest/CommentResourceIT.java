...
import com.booking.tai.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    private static final Float DEFAULT_VOTE = 1F;
    private static final Float UPDATED_VOTE = 2F;
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().content(DEFAULT_CONTENT).createdDate(DEFAULT_CREATED_DATE).vote(DEFAULT_VOTE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().content(UPDATED_CONTENT).createdDate(UPDATED_CREATED_DATE).vote(UPDATED_VOTE);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getVote()).isEqualTo(DEFAULT_VOTE);
    }
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].vote").value(hasItem(DEFAULT_VOTE.doubleValue())));
    }
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.vote").value(DEFAULT_VOTE.doubleValue()));
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).createdDate(UPDATED_CREATED_DATE).vote(UPDATED_VOTE);
        ...
        assertThat(testComment.getVote()).isEqualTo(UPDATED_VOTE);
    }
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).vote(UPDATED_VOTE);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).createdDate(UPDATED_CREATED_DATE).vote(UPDATED_VOTE);
